...
function displayMessage () {
  if (parseInt(pScore.dataset.score) === 5) {
    modalMessage.textContent = 'You Won! Computer loses!';
  }
  if (parseInt(cScore.dataset.score) === 5) {
    modalMessage.textContent = 'You lost! Computer wins!';
  }
  };
